...
```{r include = FALSE}
tree_data <- readr::read_csv('~/Project Green Arctic/2_malla/1_data/field_data/2_data_analysis/2_input/tree_data.csv')
```
...
```{r include = FALSE}
# transect meta data
transect_data <- readr::read_csv('~/Project Green Arctic/2_malla/1_data/field_data/1_malla_data_analysis/3_output/1_data_products/transect_data.csv')

transect_data <- readr::read_csv('~/Project Green Arctic/2_malla/1_data/field_data/1_malla_data_analysis/3_output/1_data_products/dung_data_transect_summary.csv') %>% 
  select(-frequency) %>% 
...
tree_transect_data <- readr::read_csv('~/Project Green Arctic/2_malla/1_data/field_data/1_malla_data_analysis/3_output/1_data_products/tree_transect_data.csv')
```
...
```{r include = FALSE}
tree_transect_data_full <- readr::read_csv('~/Project Green Arctic/2_malla/1_data/field_data/1_malla_data_analysis/3_output/1_data_products/tree_transect_data_full.csv')
```
...
tree_transect_data_full %>%
  mutate(class = factor(class, levels = facet_order)) %>% 
  ggplot(aes(section, n, color = country)) + 
  geom_boxplot() +
